...
Players merge tiles with the same numbers to reach 2048.
"""
...
class Game2048(BaseGame):
    ...
    def __init__(self, difficulty='normal'):
        ...
        self.grid_size = 4
        self.four_chance = 0.1 # Default 10%
    ...
    def compress(self, row):
        """Slide tiles to the left, removing zeros."""
    ...
    def move(self, direction):
        ...
        # Normalize to move_left by rotating
        rotations = {'left': 0, 'up': 3, 'right': 2, 'down': 1}
        
        # Rotate to position for move_left
...
def play_2048(difficulty='normal'):
